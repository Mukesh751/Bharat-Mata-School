...
<nav>
     <div class="container-fluid">   
        ...
        <li>
            ...
            <ul>
            <li><a href="welcomet.php"> Details</a></li>
            <li><a href="teacherupdate.php">Update Details</a></li>
            </ul>
        </li>
          
        <li>
            <label for="drop-1" class="toggle">Student+</label>
            <a href="#">Student</a>
            <input type="checkbox" id="drop-1"/>
            <ul>
            <li><a href="showstudentdetails.php">List</a></li>
          <li><a href="addstudent.php">Add</a></li>
            </ul>
        </li>
          
        <li>
            <label for="drop-1" class="toggle">CLass+</label>
            <a href="#">Class</a>
            <input type="checkbox" id="drop-1"/>
            <ul>
            <li><a href="showclass.php">List</a></li>
            <li><a href="addclass.php">Add Class</a></li>
            </ul>
        </li>

        <li>
            <label for="drop-1" class="toggle">Subject+</label>
            <a href="#">Subject</a>
            <input type="checkbox" id="drop-1"/>
            <ul>
            <li><a href="showsubject.php">List</a></li>
