...
<body>
    <div class="container">
        ...
        <p>
            New User? <a href="studentsignup.php">Signup here!</a>
        </p>
    </div>
</body>
</html>
...
if(isset($_POST['studentlogin']))
{
    ...
    $sel = mysqli_query($conn, "SELECT * FROM studentdata WHERE username = '$uname' and passcode = '$pass'");
    ...
    if(mysqli_num_rows($sel)>0)
    {
        ...
        window.location.replace('welcomes.php');
        </script>
        <?php
    }
    else
